...
## 9. 20260710-15 cleanup шешімі

SanaBase бұрынғы негізгі UI ішінен SanaMind-та болуы керек жеке бөлімдер алынды:
...
Маңызды: бұл cleanup деректерді өшірмейді. localStorage ішіндегі notes, tasks, goals, brain деректері backup/cloud үшін сақталады. Тек SanaBase navigation және Core UI business-only режимге келтірілді.
